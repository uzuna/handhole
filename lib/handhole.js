...
var Stacker = require('./modules/stacker');
var Conful = require('./modules/conful');
var Turnstile = require('./modules/turnstile');
...
// --[Stacker]---------------------------------------------
//
HandHole.prototype.stacker = function(target, option){
	if(arguments.length < 1) return Stacker();
	var vl = Stacker(option)
	if(target === null) return vl;
	this.insert(target, vl);
	return vl;
}
...
// --[Conful]---------------------------------------------
//
HandHole.prototype.conful = function(target, option){
	if(arguments.length < 1) return Conful();
	var vl = Conful(option)
	vl.conful(target);
	return vl;
}

module.exports.conful = Conful;



// --[Turnstile]---------------------------------------------
//
HandHole.prototype.turnstile = function(target, option){
	if(arguments.length < 1) return Turnstile();
	var vl = Turnstile(option)
	vl.turnstile(target);
	return vl;
}
